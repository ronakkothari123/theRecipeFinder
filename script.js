...
function initializeList(){
    ...
    completeDishList.push(pavBhaji, lentilRice, lemongrassTofu, gobiManchurian, pasta, potatoVada, chole, burger, sandwich)
    shuffle(completeDishList)
}
...
function createRating(){
    for(i = 0; i < completeDishList.length; i++){
        ...
        completeDishList[i].rating = (ratingVar / completeDishList[i].items.length * 100).toFixed(1)
...
function addToList(){
    ...
    if(foodNameValue == "Cilantro"){
        foodNameInput.value = "Coriander"
        addToList()
    }
    else if(itemArray.includes(foodNameValue)){
